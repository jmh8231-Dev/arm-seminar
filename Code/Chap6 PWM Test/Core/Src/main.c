...
//  HAL_TIM_Base_Start_IT(&htim7);
  ...
  {
	  //예제 1 서보모터 각도 제어
//	  for(int i = 300; i < 1320; i++) {
//		  TIM2->CCR2 = i;
//		  HAL_Delay(1);
//	  }
//
//	  for(int i = 1320; i > 300; i--) {
//	  		  TIM2->CCR2 = i;
//	  		  HAL_Delay(1);
//	  }


	  // 예제 2 가변저항에 따른 서보 각도제어
//	  TIM2->CCR2 = map(adc1_val[0], 0, 4095, 300, 1320);
//
//	  if(lcd_flag) {
//		  lcd_flag = 0;
//
//		  sprintf(str, "ADC: %4d CCR: %4d", adc1_val[0], TIM2->CCR2);
